...
exports.getPropertyDetail = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/properties");
var getPropertyDetail = function getPropertyDetail(property) {
  return _axios.default.get("".concat(url, "?id=").concat(property)).then(function (response) {
...
exports.mapPropertyDetailFromApiToViewModel = void 0;
var mapPropertyDetailFromApiToViewModel = function mapPropertyDetailFromApiToViewModel(propertyDetail) {
  console.log(propertyDetail.map(function (property) {
    return mapPropertyFromApiToViewModel(property);
  }));
};
exports.mapPropertyDetailFromApiToViewModel = mapPropertyDetailFromApiToViewModel;
...
(0, _propertyDetail.getPropertyDetail)(params.id).then(function (property) {
  var propertyDetail = (0, _propertyDetail3.mapPropertyDetailFromApiToViewModel)(property);
  console.log(propertyDetail);
  (0, _propertyDetail2.setPropertyValues)(propertyDetail);
});
},{"../../core/router":"core/router/index.js","./property-detail.api":"pages/property-detail/property-detail.api.js","./property-detail.helpers":"pages/property-detail/property-detail.helpers.js","./property-detail.mappers":"pages/property-detail/property-detail.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
